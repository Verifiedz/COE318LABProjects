...
//Initialize the instance variables
    ...
    public ComplexNumber negate() {
        //return Math.negateExact(this.re,this.im);
    ...
    public ComplexNumber add(ComplexNumber z) {
        ...
        return new ComplexNumber((this.re + z.re), (this.im + z.im));	//A stub: to be fixed
    }
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        ...
        return new ComplexNumber((this.re*z.re -this.im*z.im) , (this.re*z.im + this.im*z.re)) ;	//A stub: to be fixed
    }
    ...
    public ComplexNumber divide(ComplexNumber z) {
        ...
        return new ComplexNumber (((this.re*z.re)+(this.im*z.im))/(z.re*z.re +z.im*z.im),+ ((this.im*z.re)-(this.re*z.im))/(z.re*z.re +z.im*z.im));	//A stub: to be fixed
    }
