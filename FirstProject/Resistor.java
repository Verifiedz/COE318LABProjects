 ...
 *
 * @author Saad Wasim #501052735
 */
package coe318.lab1;
public class Resistor {
   private double Volts = 0; //only visible in the set class due to the private keyword
 ...
 */
 public void setVoltage(double voltage) {
    ...
    else { System.out.println("Error: occured voltage surpassed restriction."); 
    }
 //FIX THIS
 }
 /**
 ...
 */
 public void setCurrent(double current) {
    ...
    else { System.out.println(" Error: occured current surpassed restriction."); 
 //FIX THIS
    }
 }
 /**
